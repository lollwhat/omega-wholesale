...
public class ItemController extends CRUDController<Item> {
    ...
    public void addItem(String itemCode, String itemName, String unit, String unitPrice) {
        try {
            ...
            if (existingItemDetails == null) {
                ...
                Item item = new Item("IM" + String.format("%03d", tempItemId), itemCode, itemName, unit, unitPrice, createdAt, createdAt, createdBy, updatedBy);
                add(item);
            } else {
    ...
    public void updateItem(String itemEntryId, String itemCode, String itemName, String unit, String unitPrice) {
        try {
            ...
            Item item = new Item(itemEntryId, existingItemDetails[1], existingItemDetails[2], existingItemDetails[3], existingItemDetails[4], existingItemDetails[5], existingItemDetails[6], existingItemDetails[7], existingItemDetails[8]);
