...
public class DailySalesEntryController extends CRUDController<DailySalesEntry> {
    ...
    public void addDailySalesEntry(String itemId, String itemName, int quantity, String salesDate, int totalPrice) {
        ...
        DailySalesEntry dailySalesEntry = new DailySalesEntry("DSE" + String.format("%03d", tempItemId), itemId, itemName, salesDate, quantity, totalPrice, createdAt, createdBy, createdAt, updatedBy);
        add(dailySalesEntry);
        String data = dailySalesEntry.toCSV();
        FileController.appendFile(data);
        System.out.println("Daily sales entered successfully");
    ...
    public void updateItem(String dailySalesId, String itemId, String itemName, String salesDate, int quantity, int totalPrice) {
        try {
            ...
            DailySalesEntry dailySalesEntry = new DailySalesEntry(dailySalesId, itemId, itemName, salesDate, quantity, totalPrice, existingDailySalesEntryDetails[4], existingDailySalesEntryDetails[5], existingDailySalesEntryDetails[6], existingDailySalesEntryDetails[7]);
            ...
            dailySalesEntry.setTotalPrice((totalPrice != 0) ? totalPrice : Integer.parseInt(existingDailySalesEntryDetails[5]));
