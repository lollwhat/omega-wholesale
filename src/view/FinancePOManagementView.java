...
public class FinancePOManagementView extends JFrame {
    ...
    class POActionButtonPanel extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
        ...
        private FinancePOManagementView parentView;
        private String currentPoId;

        public POActionButtonPanel(JTable table, FinancePOManagementView parentView) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            FinancePOManagementView poViewInstance = new FinancePOManagementView();
