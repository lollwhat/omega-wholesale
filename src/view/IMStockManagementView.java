...
public class IMStockManagementView extends JFrame {
    ...
    public JPanel createStockManagementPanel() {
        ...
        buttonPanel.add(generateStockReportButton);
        ...
        JPanel alertPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 20, 10));
        alertPanel.add(inStockLabel);
        alertPanel.add(lowStockLabel);
        alertPanel.add(outOfStockLabel);
        alertPanel.setBackground(new Color(0, 0, 0));

        headerPanel.add(titlePanel, BorderLayout.NORTH);
        headerPanel.add(buttonPanel, BorderLayout.CENTER);
        headerPanel.add(alertPanel, BorderLayout.SOUTH);
        ...
        public StockActionButtonPanel(JTable table) {
            ...
            raisePRButton.addActionListener(e -> {
                ...
                AddPurchaseRequisitionForm prForm = new AddPurchaseRequisitionForm(
                        (JFrame) SwingUtilities.getWindowAncestor(IMStockManagementView.this), // Parent Frame
                        itemsForPR
                );
